...
func NewImgHelper(path string) *ImgHelper {
	return &ImgHelper{path: path}
}

type ImgHelperService interface {
...
func (i *ImgHelper) LoadImage() (image.Image, error) {
...
func (i *ImgHelper) ConvertToTensor(img image.Image) [][]color.Color {
...
func (i *ImgHelper) CreateNewImage(name string, pixels [][]color.Color) error {
